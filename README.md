...
-->
<h1 align="center">Hey, I'm Harshita Rajput 👨‍💻</h1>
<p align="center">
  <em>Frontend Developer • Backend Developer • Debugging Enthusiast</em>
</p>
...
var harshita = {
  ...
  tools: ['Javascript', 'Python', 'MySql', 'Java', 'JUnit'],
  learning: ['.Net', 'MongoDB', 'advanced system architecture'],
...
- 🏗 Designing frontend flows with reliability and performance in mind  
...
|------------|------------------|--------------------------|---------------------|
| Python 👨🏻‍💻   | MongoDB 🛢️        |Visual Studio Code 🗑️      | Testing, Monitoring |
| JS (React) ⚛️ | Redis 🚀          | Zookeeper, Git, Postman | CI/CD, Test Suites  |
| Java ♨️    | NoSQL(learning) / MySQL  | IntelliJ IDEA, GitLab     | Code Reviews        |
...
<p align="center"><em>"First solve the problem. Then, write the code." — Hello World </em></p>
